...
<head>
    ...
    <link href="../privacy_policy/privacy-policy.css" rel="stylesheet" type="text/css">
    <title>Privacy Policy</title>
</head>
<body class="min-h-screen flex flex-col">
<jsp:include page="/common/header.jsp"/>
<div id="privacy-policy" class="flex-1 mx-auto max-w-7xl pb-6 px-2 sm:px-6 lg:px-8">
    <h2>Privacy Policy of CEEE</h2>

    <p>CEEE operates the localhost website, which provides the SERVICE.</p>

    <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of
        Personal Information if anyone decided to use our Service, the CEEE Database website.</p>
    ...
    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible
        at localhost, unless otherwise defined in this Privacy Policy.</p>
