...
<div class="relative my-4 flex flex-1 flex-col">

    <div id="title-container"
         class="absolute place-self-center opacity-0 transition-[opacity] duration-1000 ease-in space-y-20 will-change-[opacity]">
        <h1 id="title"
            class="select-none font-extrabold leading-none tracking-tight text-gray-900 will-change-[margin-bottom,_opacity] transition-[margin-bottom_opacity] text-3xl duration-[1.5s] md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl">
            CEEE's Server
            ...
            <section id="visit-project-container" class="flex flex-col space-y-12">
                ...
                <a href="${pageContext.request.contextPath}/projects"
                   class="z-10 flex flex-1 flex-row border-2 items-center rounded-2xl py-4 px-4 will-change-[background-color,padding,transform] transition-[background-color,padding,transform] duration-300 hover:bg-emerald-400 hover:scale-95 lg:py-6 xl:py-8 2xl:py-10">
                    <img class="pointer-events-none mx-4 h-12 w-10 select-none pt-2" src="./resources/icons/link.svg"/>
