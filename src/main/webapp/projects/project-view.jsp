    ...
    <nav class="mx-16 my-6 flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="index"
                   class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="<%=request.getHeader("referer") == null ? "projects" : request.getHeader("referer")%>"
                       class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 dark:hover:text-white dark:text-gray-400 md:ml-2">Projects</a>
                </div>
            </li>
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2">${project.title}</span>
                </div>
            </li>
        </ol>
    </nav>
