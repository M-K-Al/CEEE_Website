...
<div class="grid flex-1 place-items-center">
    <div class="my-5 w-3/5 max-w-sm md:mt-0">
        <form id="login-form" method="POST">
            <div class="overflow-hidden">
                <div class="space-y-8 px-6">

                    <div class="flex select-none max-w-fit mx-auto">
                        <img class="pointer-events-none w-56" src="../resources/logos/ceee_logo.png" alt="CEEE">
                    </div>
